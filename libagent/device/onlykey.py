...
class OnlyKey(interface.Device):
    ...
    def sign(self, identity, blob):
        ...
        self.ok.send_large_message2(msg=self._defs.Message.OKSIGN, payload=test_payload,
                                    slot_id=this_slot_id)

        print('"%s" signing %r (%s) on %s', identity.to_string(), blob, curve_name, self)
    ...
    def ecdh(self, identity, pubkey):
        ...
        self.ok.send_large_message2(msg=self._defs.Message.OKDECRYPT, payload=test_payload,
                                    slot_id=this_slot_id)
