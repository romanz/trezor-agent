...
class OnlyKey(interface.Device):
    ...
    def pubkey(self, identity, ecdh=False):
        ...
        self.ok.send_message(msg = self._defs.Message.OKGETPUBKEY, 
                                       slot_id = this_slot_id, payload=data)
        ...
        if (curve_name != 'rsa'):
            ...
            if len(ok_pubkey) == 256:
                ...
                ok_pubkey = b'\x00\x00\x00\x07' + b'\x73\x73\x68\x2d\x72\x73\x61' + b'\x00\x00\x00\x03' + 
                                               b'\x01\x00\x01' + b'\x00\x00\x01\x01' + b'\x00' + bytes(ok_pubkey)
                ...
                ok_pubkey = b'\x00\x00\x00\x07' + b'\x73\x73\x68\x2d\x72\x73\x61' + b'\x00\x00\x00\x03' +
                                               b'\x01\x00\x01' + b'\x00\x00\x02\x01' + b'\x00' + bytes(ok_pubkey)
